...
print(json.dumps(_without_generated_at(payload), sort_keys=True, separators=(',', ':'), default=str))
print('\nafter roundtrip JSON:')
print(json.dumps(_without_generated_at(loaded), sort_keys=True, separators=(',', ':'), default=str))
