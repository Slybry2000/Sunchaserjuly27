...
def clamp_bbox(lat: float, lon: float, radius_km: float) -> Tuple[float, float, float, float]:
    """Return (min_lat, min_lon, max_lat, max_lon) bounding box for a given radius (km)."""
