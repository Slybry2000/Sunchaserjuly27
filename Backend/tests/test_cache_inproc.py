...
from Backend.utils.cache_inproc import CacheEntry, InProcessCache
...
class TestCacheEntry:
    ...
    def test_is_fresh(self):
        ...
        with freeze_time("2025-01-01 12:00:00") as frozen_time:
            entry = CacheEntry(
                value="test", created_at=time.time(), ttl_seconds=300, swr_seconds=60
            )
...
class TestInProcessCache:
    ...
    async def test_background_refresh_exception_handling(self, cache):
        ...
        with freeze_time("2025-01-01 12:00:00") as frozen_time:
            ...
            await cache.wait_for_bg_refresh(
                "key1", timeout=1.0, swallow_exceptions=True
            )
