"""Expand Backend/data/pnw.csv to at least N rows by duplicating and jittering existing rows.
Usage:
    python Backend/scripts/expand_dataset.py --count 100

This script will back up the original `pnw.csv` to `pnw.csv.bak` before overwriting.
"""
...
CATEGORIES = [
    'Mountain', 'Lake', 'Park', 'Gorge', 'Climbing', 'Island', 'Beach', 'Trail', 'Forest', 'Desert'
]
